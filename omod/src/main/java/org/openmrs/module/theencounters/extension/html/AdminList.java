...
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		map.put("theencounters/theencounters.page", "Encounters of Current Month Reference App");
		map.put("module/theencounters/plr.form", "Observations of Current Month");
		map.put("theencounters/plr.page", "Observations of Current Month Reference App");
