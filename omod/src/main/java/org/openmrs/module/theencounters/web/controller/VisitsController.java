 ...
 */
@Controller("${rootrootArtifactId}.VisitsController")
@RequestMapping(value = "module/theencounters/visits.form")
public class VisitsController {
	...
	private final String VIEW = "/module/theencounters/visits";
	...
	protected List<Visit> getAllVisits() throws Exception {
